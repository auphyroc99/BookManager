...
import com.bookmanager.jooq.tables.BookAuthor.BookAuthorPath;
...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The column <code>public.author.version</code>.
     */
    public final TableField<AuthorRecord, Integer> VERSION = createField(DSL.name("version"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<AuthorRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
